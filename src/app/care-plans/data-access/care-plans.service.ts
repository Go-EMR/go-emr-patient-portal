      ...
      const plans: CarePlan[] = [
        {
          ...
          careTeamMembers: ['Dr. Sarah Chen (Internal Medicine)', 'Alice Johnson, RD (Dietitian)', 'Mark Torres, CDE (Diabetes Educator)', 'AuraHealth Pharmacy'],
        ...
        },
        {
          ...
          managingProvider: 'Dr. Sarah Chen',
          careTeamMembers: ['Dr. Sarah Chen (Internal Medicine)', 'AuraHealth Pharmacy'],
